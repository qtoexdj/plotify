...
console.log(`Diff Area: ${(currentArea - planarArea).toFixed(4)} m² (${((currentArea - planarArea) / planarArea * 100).toFixed(6)}%)`);
...
console.log(`Diff Area: ${(currentBigArea - planarBigArea).toFixed(4)} m² (${((currentBigArea - planarBigArea) / planarBigArea * 100).toFixed(6)}%)\n`);
