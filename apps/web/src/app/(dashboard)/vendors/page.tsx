                                ...
                                members.map((member) => (
                                    <TableRow key={member.id} className="border-sidebar-border">
                                        ...
                                        <TableCell className="font-medium">
                                            ...
                                            {!member.first_name && !member.last_name && (member.username || "Usuario sin nombre")}
                                        </TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell>
                                            <Badge variant={member.role === 'admin' ? 'default' : 'secondary'} className={member.role === 'admin' ? 'bg-blue-600' : ''}>
                                        ...
                                        <TableCell className="text-right">
                                            {isAdmin && (
                                                <VendorActions
                                                    ...
                                                    vendorName={member.first_name ? `${member.first_name} ${member.last_name || ''}`.trim() : ''}
