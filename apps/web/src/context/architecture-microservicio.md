# Arquitectura - Plotify Microservicio

## 🏗️ Visión General
Este microservicio es responsable del procesamiento pesado de archivos CAD (DWG/DXF) y la transformación geoespacial. Funciona como un servicio auxiliar satélite al núcleo Next.js, diseñado para escalar independientemente según la carga de procesamiento de archivos.
