        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        No hay vendedores activos registrados en el sistema.
                    </CardDescription>
                </CardHeader>
            </Card>
        )
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Rendimiento por Vendedor</CardTitle>
                <CardDescription>
                    Métricas de ventas y asignaciones por cada agente activo.
                </CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        <div key={vendor.id} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                            ...
                            <div className="flex gap-4 text-right">
                                ...
                                <div className="flex flex-col items-end">
                                    ...
                                    <Badge variant="outline" className="mt-1 text-amber-600 bg-amber-50 dark:bg-amber-950/30 border-amber-200">
                                        {vendor.reservedLots}
                                    </Badge>
                                </div>
                                <div className="flex flex-col items-end">
                                    <span className="text-xs text-muted-foreground">Ventas</span>
                                    <Badge variant="secondary" className="mt-1 text-blue-600 bg-blue-50 dark:bg-blue-950/30">
                                        {vendor.soldLots}
                                    </Badge>
                                </div>
                            </div>
