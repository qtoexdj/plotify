...
} from '@/app/(dashboard)/agente/integrations/actions'
...
export function TelegramLinkCard({
  ...
  const [localChatId, setLocalChatId] = useState<string | null | undefined>(undefined)
  const currentChatId = localChatId !== undefined ? localChatId : telegramChatId
