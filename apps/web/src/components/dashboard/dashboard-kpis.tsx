        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                        Loteos gestionados en tu cuenta
                    </p>
                </CardContent>
            </Card>
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                        Suma de lotes en todos los proyectos
                    </p>
                </CardContent>
            </Card>
            <Card>
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                        Con reserva pendiente: <span className="text-amber-600 font-medium">{kpis.reservedLots}</span> lotes
                    </p>
                </CardContent>
            </Card>
        </div>
