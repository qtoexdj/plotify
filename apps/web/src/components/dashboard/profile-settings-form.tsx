    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Actualiza tus datos públicos y de contacto personal.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Tu identificador único en la plataforma.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Mismo número de los leads entrantes.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
