  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      <Card>
        ...
        <CardContent>
          <div className="font-display text-2xl font-semibold">{stats.totalReservas}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="font-display text-2xl font-semibold">{stats.totalEscrituras}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="font-display text-2xl font-semibold">{stats.ventasMes}</div>
