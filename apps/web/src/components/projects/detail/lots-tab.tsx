    ...
    const handleCreateLotRecord = async () => {
        ...
        try {
            const response = await fetch(
                `/api/projects/${projectId}/lots/${createLotForm.lot_id}`,
                {
                    method: 'PATCH',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(payload),
                ...
                {isAdmin && (
                    ...
                    >
                        ...
                        en producción incluiríamos TODOS los campos del form original */}
                            ...
                            <AlertDialogFooter>
                                {createLotError ? (
                                    <p className="text-sm text-red-600">{createLotError}</p>
                                ) : null}
                        ...
                        <div className="flex-1 overflow-y-auto px-6 pb-6 pt-2 space-y-6">
                            <div className="space-y-3">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <Input value={lotForm.numero_lote} onChange={handleLotFormChange('numero_lote')} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>Estado</Label>
                                        <Select
                                    ...
                                    <div className="space-y-2">
                                        <Label>Vendedor (ID)</Label>
                                        <Input value={lotForm.vendedor_id} onChange={handleLotFormChange('vendedor_id')} />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <Label>Observaciones</Label>
                                    <Textarea value={lotForm.observaciones} onChange={handleLotFormChange('observaciones')} />
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        <Label>Dirección</Label>
                                        <Input value={lotForm.cliente_direccion} onChange={handleLotFormChange('cliente_direccion')} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>Estado civil</Label>
                                        <Input value={lotForm.cliente_estado_civil} onChange={handleLotFormChange('cliente_estado_civil')} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>Ocupación / profesión</Label>
                                        <Input value={lotForm.cliente_ocupacion} onChange={handleLotFormChange('cliente_ocupacion')} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>Teléfono</Label>
                                        <Input value={lotForm.cliente_telefono} onChange={handleLotFormChange('cliente_telefono')} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>Correo electrónico</Label>
                                        <Input value={lotForm.cliente_email} onChange={handleLotFormChange('cliente_email')} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        <Label>Valor</Label>
                                        <Input type="number" value={lotForm.valor} onChange={handleLotFormChange('valor')} />
                                    </div>
                                    <div className="space-y-2">
                                        <Label>Abono</Label>
                                        <Input type="number" value={lotForm.abono} onChange={handleLotFormChange('abono')} />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <Label>Detalle deuda</Label>
                                    <Textarea value={lotForm.detalle_deuda} onChange={handleLotFormChange('detalle_deuda')} />
                                </div>
                            </div>
