...
import { Calendar01Icon, UserAdd01Icon, Delete02Icon as Trash01Icon } from '@hugeicons/core-free-icons'
                ...
                <Card className="lg:col-span-2">
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                <label className="text-sm font-medium text-gray-600 dark:text-slate-400">Región</label>
                                <p className="text-lg">{project.region}</p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-gray-600 dark:text-slate-400">Comuna</label>
                                <p className="text-lg">{project.comuna}</p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-gray-600 dark:text-slate-400">Estado</label>
                                <p className="text-lg">
                                    <Badge variant="secondary">{project.estado}</Badge>
                                </p>
                            </div>
                            <div>
                                <label className="text-sm font-medium text-gray-600 dark:text-slate-400">Creado</label>
                                <p className="text-lg flex items-center gap-2">
                                    ...
                                    {project.created_at ? new Date(project.created_at).toLocaleDateString('es-CL') : '—'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <label className="text-sm font-medium text-gray-600 dark:text-slate-400">Descripción</label>
                                            ...
                                            <div key={vendor.id} className="space-y-4 pt-4 first:pt-0">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-3">
                                                        <Avatar>
                                                            <AvatarImage src={vendor.user_profile?.avatar_url || ''} alt={vendor.nombre} />
