...
export async function requestReservationApproval(
  ...
  const payload: ApprovalRequestPayload = {
    ...
    cliente_nacionalidad: validData.cliente_nacionalidad,
...
export async function requestSaleApproval(
  ...
  const payload = {
    ...
    cliente_region: validData.cliente_region || null,
    cliente_comuna: validData.cliente_comuna || null,
    cliente_estado_civil: validData.cliente_estado_civil || null,
    cliente_nacionalidad: validData.cliente_nacionalidad || null,
