...
- **Artefactos SDD activos:** usa `specs/011-venta-escritura/spec.md`, `plan.md`, `tasks.md`, `research.md`, `data-model.md`, `contracts/` y `quickstart.md`.
...
- Antes de implementar una tarea del SDD 011, lee `specs/011-venta-escritura/plan.md` y `tasks.md`.
- Antes de cada tarea: revisa `git status --short` y sincroniza CodeGraph con `codegraph sync .`.
- Implementa **una sola tarea pendiente** de `specs/011-venta-escritura/tasks.md` por ciclo.
