...
- [x] T040 Recorrido 375/768/1024/1440 de TODAS las rutas renderizables (validado en producción y verificado en tests de diseño)
- [x] T041 Regresión del visor de proyecto: flujo completo desktop+móvil (validado en producción y cubierto por tests de MapLibre y layers)
